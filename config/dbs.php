...
return array(
    ...
    'servers' => array(
        'db_master' => array(                       // 服务器标记 / database identify
            ...
            'password'  => isset($_ENV['PHALAPI_DB_PASSWORD'])  ? $_ENV['PHALAPI_DB_PASSWORD']  : 'root',                      // 数据库密码 / database password
    ...
    'tables' => array(
        ...
        'userinfo' => array(                            // 表名，不带表前缀，不带分表后缀
            'prefix' => 'wp_',                         // 当前的表名前缀
            'key' => 'uid',                          // 当前的表主键名
            'keep_suffix_if_no_map' => true,        // 当分表未匹配时依然保留数字作为表后缀
        ...
        'productinfo' => array(                            // 表名，不带表前缀，不带分表后缀
            'prefix' => 'wp_',                         // 当前的表名前缀
            'key' => 'pid',                          // 当前的表主键名
            'keep_suffix_if_no_map' => true,        // 当分表未匹配时依然保留数字作为表后缀
            'map' => array(                         // 当前的分表存储路由配置
